...
<div>
  <table>
    ...
    <tr>
      <td><a href="https://github.com/Frossst61/portfolio_da/blob/main/6-A-B test/a-b_test.ipynb"> 3. Проверка гипотез по увеличению выручки в интернет-магазине — оценить результты A/B теста </a></td>
